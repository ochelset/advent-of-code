...
class Passport():
    ...
    def __init__(self, details: str):
        ...
        for detail in details.strip().split(" "):
...
class PassportScanner():
    ...
    def scan(self, passport: Passport) -> bool:
        for key in self.required:
            if not key in passport.credentials:
                return False

"""
--- Day 13: Care Package ---
As you ponder the solitude of space and the ever-increasing three-hour round trip for messages between you and Earth,
...
cabinet = ArcadeCabinet(data)
blocks = 0
for tile in cabinet.screen.items():
    if tile[1] == BLOCK:
        blocks += 1

print("Part 1:", blocks, "blocks")

cabinet.insertQuarter()
cabinet.play()
print("Part 2:", cabinet.score, "points")
